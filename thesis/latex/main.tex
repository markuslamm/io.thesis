...
\input{chapter/02-basic-concepts} \clearpage
%\input{chapter/03-data-analysis} \clearpage
\input{chapter/03-requirements-analysis} \clearpage
\input{chapter/04-architecture-implementation} \clearpage
\input{chapter/05-evaluation} \clearpage
\input{chapter/06-conclusion} \clearpage
